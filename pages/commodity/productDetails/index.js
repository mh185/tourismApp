...
Page({
    ...
    onLoad: function(options) {
        ...
        console.log('分享人ID' + options.userId);
    ...
    orderData() {
        ...
        details.goods_type = 0 // //类型(0:一般商品 ;1：秒杀订单；2：拼团订单；3：积分兑换)
        ...
        orderData(orderLists, 'productDetails');
    ...
    specificaBtn: function() {
        if (this.data.selectsLabel != null) {
            if (this.data.type == 1) {
                ...
                // var list=[]
                // var shopInfor={
                //   cartId:this.data.selectsLabel.id,  // 規格id
                //   cartLabel:this.data.selectsLabel.labelName, // 规格名称
                //   cartNum:this.data.number,  // 数量
                //   cartPrice:this.data.selectsLabel.price,  // 价格
                //   freightPrice: this.data.detailInfor.freightPrice,
                //   goodsId:this.data.detailInfor.id,  // 商品Id
                //   goodsLabel: [],
                //   headImg:this.data.detailInfor.headImg, //
                //   integral: 0,
                //   name: this.data.detailInfor.name,  // 商品名称
    ...
    onShareAppMessage: function(res) {
        ...
        return {
            ...
            path: '/pages/commodity/productDetails/index?id=' + that.data.id + '&userId=' + this.data.userId,
